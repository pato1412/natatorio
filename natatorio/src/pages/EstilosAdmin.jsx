...
import { Container, Card, Form, Button, ListGroup, Badge, Alert, Spinner } from "react-bootstrap";
import {
  collection,
  addDoc,
  doc,
...
export default function EstilosAdmin() {
  ...
  const handleAdd = async (e) => {
    ...
    try {
      ...
      await addDoc(collection(db, "estilos"), {
        label,
        order: maxOrder + 1,
        active: true,
      });
  ...
  return (
    <div className="min-vh-100 swim-safe-bottom">
      <PageHeader title="Administrar estilos" subtitle="Estos estilos se usan en el formulario de registro de tiempos" />
      <Container fluid="lg">
            ...
            {loading ? (
              ...
              <div>
                <div className="small text-swim-muted mb-3">
                  Todavía no hay estilos cargados.
                </div>
